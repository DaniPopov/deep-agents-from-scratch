...
class SubAgent(TypedDict):
    ...
    name: str # The name of the sub-agent
    description: str # The description of the sub-agent
    prompt: str # The prompt of the sub-agent
    tools: NotRequired[list[str]] # The tools of the sub-agent (as a list of strings)
